<h2>수정중</h2>
<h1>초보 운전자를 위한 운전연수 - 'Crossroads'</h1>


<h2>1. 기획 의도</h2>
<div dir="auto" style="display: flex;">
<img width="1180" alt="스크린샷 2022-12-27 오전 12 09 34" src="https://user-images.githubusercontent.com/122762202/231323324-e72adf0c-24ce-4321-9bf1-a8b9839a7555.png" style = "width: 45%; height : 45%">
</div>


<h2>2. 기대 효과</h2>
<img width="1161" alt="스크린샷 2022-12-27 오전 12 20 31" src="https://user-images.githubusercontent.com/122762202/231323600-7716c772-d058-4565-8678-49b53cb4fb62.png" style = "width: 45%; height : 45%">


<h2>3. 프로젝트 사용 툴</h2>
<img width="1160" alt="스크린샷 2022-12-27 오전 12 23 33" src="https://user-images.githubusercontent.com/122762202/231323672-dbfdd9c1-a75b-47f7-a571-c63e1bc6c2bf.png" style = "width: 45%; height : 45%">
...
4-1. 메인 페이지
- 메인 페이지 링크 연결
- thymeleaf를 사용해 메인에 나오는 후기 게시판 상위4개 출력
- 기존 게시판 내용(tbl_review) DB 조회
  
4-2. 이용 후기 게시판 - 게시판 목록
  - 이용 후기 불러오기
  - 자신이 작성한 게시글만 수정/삭제 가능기능
  - 
  - 퀘스트 달성 여부 업데이트
  - 퀘스트 달성 여부에 따라 화면 변화

4-3. 이용 후기 게시판 - 게시판 작성
  - 완료한 퀘스트 내역 조회
  - 완료한 퀘스트 내역 페이징 처리

4-4. 이용 후기 게시판 - 게시판 수정
  - 획득한 뱃지 조회
  - 뱃지별 정보 조회
  - 회원 정보 조회
  - 월별 퀘스트 달성률에 따른 월별 뱃지 상태 조회
  
4-5. 이용 후기 게시판 - 게시판 삭제
  - 획득한 뱃지 조회
  - 뱃지별 정보 조회
  - 회원 정보 조회
  - 월별 퀘스트 달성률에 따른 월별 뱃지 상태 조회
...
<h2>5. 느낀점</h2>
<h3>5-1. 어려웠던 부분</h3>
📌처음 사용하는 Thymeleaf 기술을 이용해 이용 게시판 목록을 무한스크롤,페이징 처리로 만드는게 어려웠다. <br>
✔ 시간이 조금 더 걸렸지만 Thymeleaf에 대해 공부,이해한 후 ajax로 페이징 처리 하는것을 공부하고 문제를 해결했다..<br><br>
📌프로젝트  <br>
